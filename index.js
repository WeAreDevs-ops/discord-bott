    ...
    try {
        const response = await fetch('https://api.openai.com/v1/completions', {
            ...
            body: JSON.stringify({
                ...
                prompt: `You are a witty, sarcastic Discord bot that gives smart roasts, funny arguments, or sarcastic replies. A user named ${username} just said: "${userMessage}". Give them a clever, funny roast or sarcastic comeback. Keep it under 200 characters and make it entertaining but not too harsh.`,
                max_tokens: 100,
                temperature: 0.9,
                top_p: 1,
        ...
        return "My roast generator is broken right now. Consider yourself lucky! 😏";
    }
}
