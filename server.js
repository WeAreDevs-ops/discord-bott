...
app.get('/api/servers', requireAuth, async (req, res) => {
    try {
        ...
        console.log(`Returning ${guildsWithBotInfo.length} servers with bot info`);
...
// Auto role settings
app.post('/api/dashboard/:guildId/settings/autorole', requireAuth, requireGuildAdmin, async (req, res) => {
    const { guildId } = req.params;
...
app.post('/api/dashboard/:guildId/settings/automod', requireAuth, requireGuildAdmin, async (req, res) => {
    const { guildId } = req.params;
...
app.post('/api/dashboard/:guildId/settings/restrictions', requireAuth, requireGuildAdmin, async (req, res) => {
    const { guildId } = req.params;
    ...
    try {
        ...
        if (action === 'add' && !restrictedChannels.includes(channelId)) {
