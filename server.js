...
const DISCORD_REDIRECT_URI = process.env.DISCORD_REDIRECT_URI || `${process.env.RAILWAY_PUBLIC_DOMAIN ? `https://${process.env.RAILWAY_PUBLIC_DOMAIN}` : 'http://localhost:5000'}/auth/discord/callback`
