...
app.get('/api/servers', requireAuth, (req, res) => {
    ...
    // Add bot presence info with better member count handling
    const guildsWithBotInfo = adminGuilds.map(guild => {
        const botGuild = client ? client.guilds.cache.get(guild.id) : null;
        const memberCount = botGuild ? botGuild.memberCount : guild.approximate_member_count || null;
        ...
        return {
            ...
            displayMemberCount: memberCount || 'Unknown'
        };
    });
