...
function generateBotInviteLink(guildId) {
  ...
  // Use a simpler invite link that doesn't require OAuth callback for bot invitations
  return `https://discord.com/api/oauth2/authorize?client_id=${clientId}&permissions=${permissions}&guild_id=${guildId}&scope=${scope}&disable_guild_select=true`;
}
